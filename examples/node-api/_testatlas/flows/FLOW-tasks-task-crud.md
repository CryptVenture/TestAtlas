...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Create, list, update, and delete tasks via the API

## Persona

(Which persona drives this flow? Link to `personas/<slug>.md`.) task-owner

## Domain

(Which domain owns this flow? Link to `domains/<slug>/`.) domain-tasks
