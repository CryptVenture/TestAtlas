...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Confirm the application process is responsive via GET /api/health

## Persona

(Which persona drives this flow? Link to `personas/<slug>.md`.) ops-engineer

## Domain

(Which domain owns this flow? Link to `domains/<slug>/`.) domain-api
