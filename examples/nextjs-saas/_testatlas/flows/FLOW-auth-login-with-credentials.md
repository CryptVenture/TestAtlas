...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Submit email and password to /api/auth/login and land on /dashboard
