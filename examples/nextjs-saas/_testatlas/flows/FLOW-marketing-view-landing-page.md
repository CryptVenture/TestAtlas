...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Render the marketing home page and follow the sign-in or sign-up CTA

## Persona

(Which persona drives this flow? Link to `personas/<slug>.md`.) anonymous-visitor

## Domain

(Which domain owns this flow? Link to `domains/<slug>/`.) domain-marketing
