...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Move between the dashboard home and settings as an authenticated user
...
(Which domain owns this flow? Link to `domains/<slug>/`.) domain-dashboard
