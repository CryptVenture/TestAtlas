...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Type a non-empty title, click Add Item, see the item appended to the list
...
(Which domain owns this flow? Link to `domains/<slug>/`.) domain-web-components
