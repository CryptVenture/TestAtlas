...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) GET /api/items, expect 200 with an items array (possibly empty)
