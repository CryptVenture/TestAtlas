...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) GET /api/health, expect 200 with status: ok
...
(Which domain owns this flow? Link to `domains/<slug>/`.) domain-health
