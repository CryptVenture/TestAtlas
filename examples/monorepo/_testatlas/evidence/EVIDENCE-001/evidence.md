...
id: EVIDENCE-001
type: log
path: evidence/EVIDENCE-001/capture.bin
...
evidence/EVIDENCE-001/capture.bin
...
pnpm list output showing @repo/shared resolved twice with different file: refs after a partial workspace install
