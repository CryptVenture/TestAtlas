...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Render the FlatList of mock posts inside the bottom-tab feed route
