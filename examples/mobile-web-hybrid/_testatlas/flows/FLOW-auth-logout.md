...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Invoke api-client logout from the profile tab and return to the home screen
