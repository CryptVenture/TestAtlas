...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Render the universal home screen with sign-in and feed CTAs

## Persona

(Which persona drives this flow? Link to `personas/<slug>.md`.) first-time-user
