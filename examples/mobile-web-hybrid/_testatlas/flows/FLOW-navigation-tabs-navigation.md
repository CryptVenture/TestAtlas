...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Switch between the feed and profile tabs without losing tab state
...
(Which domain owns this flow? Link to `domains/<slug>/`.) domain-navigation
