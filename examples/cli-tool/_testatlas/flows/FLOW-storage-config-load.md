...
(What does the persona accomplish? Stated as a verb phrase: "checkout a cart", "reset a password", "invite a teammate".) Load .todorc.example.json defaults at startup
...
(Which domain owns this flow? Link to `domains/<slug>/`.) domain-storage
