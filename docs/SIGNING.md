...
cosign verify-blob-attestation \
  ...
  --certificate-identity-regexp 'https://github.com/<org>/testatlas/\.github/workflows/release\.yml@refs/tags/v.*' \
...
curl -fsSL https://github.com/<org>/testatlas/releases/download/v0.1.0/testatlas-0.1.0.tgz.sigstore.json \
