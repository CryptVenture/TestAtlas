<!-- TestAtlas command: atlas-core-brain-export. Paste .testatlas/bootstrap.md first; description: Export the V2 brain as a JSON dump, a graph snapshot, or a full archive — for handoff, dashboards, or backup. -->
...
First read `.testatlas/bootstrap.md`. Then read `prompts/atlas-core-brain-export.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
