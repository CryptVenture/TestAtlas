<!-- TestAtlas command: atlas-test-flow. Paste .testatlas/bootstrap.md first; description: Execute scenarios from tests/matrix.json against the running target product, capture per-state evidence, and emit RUN-<timestamp>.{md,json} per PRD §12.15 and §13. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/test-flow.md" hash="f2fd11a77c0658dfbb47d09a1598518f4390c8bfeaab0f6db593becd939ca36b" -->
