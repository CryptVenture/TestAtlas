<!-- TestAtlas command: atlas-explore. Paste .testatlas/bootstrap.md first; description: Umbrella explorer router — classify which sub-explorers (ui/cli/api/docs/runtime/data/integrations/accessibility/performance/security) apply to the target product and emit a recommendation document. -->
