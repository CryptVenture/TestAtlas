<!-- TestAtlas command: atlas-explore. Paste .testatlas/bootstrap.md first; description: Umbrella explorer orchestrator — classifies sub-explorers, spawns the recommended ones in parallel via subagent-spawn, and aggregates findings into _testatlas/02_product_overview.md alongside _testatlas/explore-plan.md. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/explore.md" hash="617c13f6ac67b468514b9a74fe2ddcd984f1a0efdfeb1ad5578a5e36f3dac577" -->
First read `.testatlas/bootstrap.md`. Then read `prompts/atlas-explore.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
