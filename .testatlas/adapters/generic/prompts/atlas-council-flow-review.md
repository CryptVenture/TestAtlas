<!-- TestAtlas command: atlas-council-flow-review. Paste .testatlas/bootstrap.md first; description: Roundtable review of a single user flow — personas read the flow doc, route map, evidence, and run logs and contribute findings, claims, and disagreements through the 9-round protocol. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/council/council-flow-review.md" hash="a4971fbf61e5e2c7d91b0b009cb87bd0b2572c1e1729586d05a4b153d7e382a3" -->
First read `.testatlas/bootstrap.md`. Then read `prompts/atlas-council-flow-review.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
