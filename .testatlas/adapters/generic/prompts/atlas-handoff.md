<!-- TestAtlas command: atlas-handoff. Paste .testatlas/bootstrap.md first; description: Write a sub-agent handoff record at _testatlas/handoffs/HANDOFF-<timestamp>.{md,json} validating against sub-agent-handoff.schema.json with explicit context boundaries. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/handoff.md" hash="c7248f39402c27b61ca64c92cba0ad588be56f4436bbdc6d97729491859e9019" -->
First read `.testatlas/bootstrap.md`. Then read `prompts/atlas-handoff.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
