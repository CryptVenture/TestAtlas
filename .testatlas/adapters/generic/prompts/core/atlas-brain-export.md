<!-- TestAtlas command: atlas-brain-export. Paste .testatlas/bootstrap.md first; description: Export the V2 brain as a JSON dump, a graph snapshot, or a full archive — for handoff, dashboards, or backup. -->
