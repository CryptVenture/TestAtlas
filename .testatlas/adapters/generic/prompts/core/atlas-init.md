<!-- TestAtlas command: atlas-init. Paste .testatlas/bootstrap.md first; description: Bootstrap or upgrade a TestAtlas V2 workspace — creates `_testatlas/brain/` skeleton, registers adapters, and writes a v2 manifest. -->
