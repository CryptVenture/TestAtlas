<!-- TestAtlas command: atlas-brain-sync. Paste .testatlas/bootstrap.md first; description: Detect and reconcile drift between markdown artifacts and brain JSON indexes; orchestrates sync-markdown-json + validate-brain. -->
