<!-- TestAtlas command: atlas-status. Paste .testatlas/bootstrap.md first; description: Summarize the current TestAtlas workspace — phase, counts, blockers, stale areas — by reading the V2 brain state. -->
