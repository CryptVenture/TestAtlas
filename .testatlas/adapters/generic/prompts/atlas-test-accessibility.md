<!-- TestAtlas command: atlas-test-accessibility. Paste .testatlas/bootstrap.md first; description: Execute accessibility-typed scenarios using Chrome DevTools MCP lighthouse_audit + ARIA introspection; assert against PRD §13.9 thresholds; emit RUN-<timestamp>.{md,json} with per-scenario a11y findings. -->
