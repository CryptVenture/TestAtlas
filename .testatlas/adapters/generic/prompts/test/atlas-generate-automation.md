<!-- TestAtlas command: atlas-generate-automation. Paste .testatlas/bootstrap.md first; description: Generate framework-specific automation skeletons (Playwright, Cypress, API, CLI, contract, smoke) from documented flows. Output marked `generated-but-not-validated` until executed. -->
