<!-- TestAtlas command: atlas-council. Invoke as /atlas-council. Description: Umbrella router for V2 council commands. Selects a conversation mode + topic + participants and dispatches to the matching council-* sub-command. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/council/council.md" hash="e46123e27d8d0e088193c26c0bb524028c57cb34f7acd745d5bd05d75e69b68b" -->
First read `.testatlas/bootstrap.md`. Then read `.agents/commands/atlas-council.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
