<!-- TestAtlas command: atlas-council-test-plan. Invoke as /atlas-council-test-plan. Description: Test Plan Council — QA, automation, codebase, data, and runtime personas propose a complete testing plan through the 9-round protocol. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/council/council-test-plan.md" hash="1dbdb6aaada5c4e7d08fc8af3069348de19d6ca438a088e5e2d57a585a2078e7" -->
First read `.testatlas/bootstrap.md`. Then read `.agents/commands/atlas-council-test-plan.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
