<!-- TestAtlas command: atlas-brain-validate. Invoke as /atlas-brain-validate. Description: Run AJV validation across the entire `_testatlas/brain/` tree (22 files) and report any findings. -->
