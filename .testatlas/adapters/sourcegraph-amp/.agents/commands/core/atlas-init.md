<!-- TestAtlas command: atlas-init. Invoke as /atlas-init. Description: Bootstrap or upgrade a TestAtlas V2 workspace — creates `_testatlas/brain/` skeleton, registers adapters, and writes a v2 manifest. -->
