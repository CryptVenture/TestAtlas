<!-- TestAtlas command: atlas-create-persona. Invoke as /atlas-create-persona. Description: Author a new persona (system, generated, or project scope) by invoking scripts/create-persona.js — emits persona.{md,json} pair under _testatlas/agents/personas/<type>/<id>.{md,json} and updates brain/personas.json. -->
