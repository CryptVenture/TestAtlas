<!-- TestAtlas command: atlas-test-domain. Invoke as /prompts:atlas-test-domain. Description: Execute domain-scoped test scenarios across PRD §26 modes (negative / state / integration / setup-testability); the scenario's `type` field selects the mode. -->
