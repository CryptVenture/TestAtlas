<!-- TestAtlas command: atlas-report. Invoke as /prompts:atlas-report. Description: Aggregate runs, issues, evidence, and coverage into reports/REPORT-latest.md (and a timestamped copy) with all 17 PRD §20 sections; refresh per-area views and the quality scorecard. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/report.md" hash="c6cbb7ea29a1eaf7a6c42fba68a4dc6751ef1ebdccb53460d918985c8385230a" -->
First read `.testatlas/bootstrap.md`. Then read `.codex/prompts/atlas-report.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
