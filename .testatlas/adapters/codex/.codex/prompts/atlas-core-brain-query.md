<!-- TestAtlas command: atlas-core-brain-query. Invoke as /prompts:atlas-core-brain-query. Description: Answer a question about the workspace by reading brain JSON; cite file paths for every claim. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/core/brain-query.md" hash="515ecaeb873eaafe59ccfc503fb6c5114139c513bc5ecc5bd3771eb07e4408d1" -->
First read `.testatlas/bootstrap.md`. Then read `.codex/prompts/atlas-core-brain-query.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
