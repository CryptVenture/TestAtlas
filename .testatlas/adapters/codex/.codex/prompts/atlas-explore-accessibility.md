<!-- TestAtlas command: atlas-explore-accessibility. Invoke as /prompts:atlas-explore-accessibility. Description: Evaluate keyboard nav, focus, labels, semantics, contrast, and dynamic feedback per PRD §13.9 using Chrome DevTools MCP lighthouse_audit + ARIA introspection; degrade to code-reading without MCP. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/explore-accessibility.md" hash="91376adfe951cefb" -->
