<!-- TestAtlas command: atlas-generate-scenarios. Invoke as /prompts:atlas-generate-scenarios. Description: Generate exploratory charters and manual test scenarios from documented flows under `_testatlas/flows/`. Output marked `generated-not-yet-validated` until executed. -->
