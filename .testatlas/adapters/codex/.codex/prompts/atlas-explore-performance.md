<!-- TestAtlas command: atlas-explore-performance. Invoke as /prompts:atlas-explore-performance. Description: Detect user-visible slowness, blocking interactions, retries, and reliability per PRD §13.10 using Chrome DevTools MCP performance traces + emulate for throttling; degrade to source-code reading without MCP. -->
