<!-- TestAtlas command: atlas-explore-api. Invoke as /prompts:atlas-explore-api. Description: Map REST/GraphQL/RPC/server-action/webhook/event-consumer surfaces; capture contracts, auth, errors, pagination; safely probe sandbox endpoints. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/explore-api.md" hash="782e00dc816cc12974c0944bd53cab1d1a4cfdbc9886c8680cdb6278604b7bbe" -->
First read `.testatlas/bootstrap.md`. Then read `.codex/prompts/atlas-explore-api.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
