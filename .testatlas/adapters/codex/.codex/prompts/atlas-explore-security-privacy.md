<!-- TestAtlas command: atlas-explore-security-privacy. Invoke as /prompts:atlas-explore-security-privacy. Description: Map auth flows, permission boundaries, sensitive-data handling, injection risks, and privacy controls. V2 expansion of V1 explore-security with mandatory walkthrough when browser+MCP available. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/explore/explore-security-privacy.md" hash="6dcfec4fcda8d1ba302c0694bed287223e38f6f91545929e458c4e9fa7996d4a" -->
First read `.testatlas/bootstrap.md`. Then read `.codex/prompts/atlas-explore-security-privacy.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
