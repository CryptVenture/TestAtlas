<!-- TestAtlas command: atlas-brain-export. Invoke as /atlas-brain-export.md. Description: Export the V2 brain as a JSON dump, a graph snapshot, or a full archive — for handoff, dashboards, or backup. -->
