<!-- TestAtlas command: atlas-council-bug-triage. Invoke as /atlas-council-bug-triage.md. Description: Bug triage council — multiple personas classify and prioritize open issues by severity, priority, and remediation sequencing through the 9-round protocol. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/council/council-bug-triage.md" hash="4df728cb728ec722abcd4879f72590f1587bafae027bc39215cf0bb2f24b8e86" -->
First read `.testatlas/bootstrap.md`. Then read `.clinerules/workflows/atlas-council-bug-triage.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
