<!-- TestAtlas command: atlas-log-issue. Invoke as /atlas-log-issue.md. Description: Capture a quality finding as an issue under to_fix/ with severity, confidence, evidence references, and back-links to flows/domains per PRD §17. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/log-issue.md" hash="dfa2b23d30edd99329188b1ab50f44d5ce1980c4f45b739a83ceb1bdac42569d" -->
First read `.testatlas/bootstrap.md`. Then read `.clinerules/workflows/atlas-log-issue.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
