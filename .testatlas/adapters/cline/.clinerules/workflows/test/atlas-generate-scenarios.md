<!-- TestAtlas command: atlas-generate-scenarios. Invoke as /atlas-generate-scenarios.md. Description: Generate exploratory charters and manual test scenarios from documented flows under `_testatlas/flows/`. Output marked `generated-not-yet-validated` until executed. -->
