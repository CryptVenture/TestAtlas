<!-- TestAtlas command: atlas-test-flow. Invoke as /atlas-test-flow.md. Description: Execute scenarios from tests/matrix.json against the running target product, capture per-state evidence, and emit RUN-<timestamp>.{md,json} per PRD §12.15 and §13. -->
