<!-- TestAtlas command: atlas-init. Invoke as /atlas-init.md. Description: Bootstrap the _testatlas/ workspace tree in a target repository — 23 subdirs, 14 canonical files, and a project manifest — idempotently. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/init.md" hash="f9e0542bec20364d7184f8b2f067676197e37c9ea986437f1cf44bef0c199c25" -->
First read `.testatlas/bootstrap.md`. Then read `.clinerules/workflows/atlas-init.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
