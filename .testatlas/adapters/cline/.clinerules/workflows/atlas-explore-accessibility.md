<!-- TestAtlas command: atlas-explore-accessibility. Invoke as /atlas-explore-accessibility.md. Description: Evaluate keyboard nav, focus, labels, semantics, contrast, and dynamic feedback per PRD §13.9 using Chrome DevTools MCP lighthouse_audit + ARIA introspection; degrade to code-reading without MCP. -->
