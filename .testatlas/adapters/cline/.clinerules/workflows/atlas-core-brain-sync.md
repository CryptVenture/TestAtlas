<!-- TestAtlas command: atlas-core-brain-sync. Invoke as /atlas-core-brain-sync.md. Description: Detect and reconcile drift between markdown artifacts and brain JSON indexes; orchestrates sync-markdown-json + validate-brain. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/core/brain-sync.md" hash="57f51f0259b82947e940d817eaaa4529b03425ea55b3e28424239a9dee9c42ac" -->
First read `.testatlas/bootstrap.md`. Then read `.clinerules/workflows/atlas-core-brain-sync.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
