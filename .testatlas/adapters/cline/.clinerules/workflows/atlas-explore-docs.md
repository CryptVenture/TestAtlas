<!-- TestAtlas command: atlas-explore-docs. Invoke as /atlas-explore-docs.md. Description: Inventory README, PRDs, stories, ADRs, specs, and supporting docs in the target repo; normalize substantial requirements into _testatlas/stories/; flag stale or conflicting docs. -->

<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/explore-docs.md" hash="034ae847eb765c2ab73b76525887360d299b4aecc0a31f151d7a1a7d6d9b1786" -->
First read `.testatlas/bootstrap.md`. Then read `.clinerules/workflows/atlas-explore-docs.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
