<!-- TestAtlas command: atlas-test-accessibility. Invoke as /atlas-test-accessibility.md. Description: Execute accessibility-typed scenarios using Chrome DevTools MCP lighthouse_audit + ARIA introspection; assert against PRD §13.9 thresholds; emit RUN-<timestamp>.{md,json} with per-scenario a11y findings. -->
