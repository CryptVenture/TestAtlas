---
name: atlas-council-brain-audit
...
<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/council/council-brain-audit.md" hash="5aefc2a354191d32ea6efe637a68937eb82ed34b8f4164a6b11284babf604549" -->
First read `.testatlas/bootstrap.md`. Then read `.continue/prompts/atlas-council-brain-audit.prompt.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
...
- **objective:** "Produce <persona-id>'s independent brain-audit findings on the brain section under audit."
