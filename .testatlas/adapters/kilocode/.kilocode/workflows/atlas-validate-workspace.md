...
<!-- TESTATLAS:GENERATED:START section="adapter-body" source="commands/validate-workspace.md" hash="ab7ed9b9a2baff6943e979a36bcfba7e26c477e0608aa107e20895b2b899c795" -->
First read `.testatlas/bootstrap.md`. Then read `.kilocode/workflows/atlas-validate-workspace.md` (already loaded into your context if invoked via slash). Follow both exactly. If they conflict, bootstrap safety and persistence rules win unless this command is more specific and not less safe.
