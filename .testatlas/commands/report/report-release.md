...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT modify any source artifacts. Reads `_testatlas/brain/quality_scores.json`, `drift.json`, `issues.json`, `decisions.json`, `risks.json`, `agent_sessions.json`. Writes only `_testatlas/reports/release_readiness.md`.
---

# TestAtlas Command (V2 report): report-release
