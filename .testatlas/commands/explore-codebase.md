...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT execute destructive shell commands. Does NOT mutate target-repo source files. Does NOT fabricate routes, handlers, or integrations from training-data priors when shell is unavailable — degrade per bootstrap §4.
---

# TestAtlas Command: explore-codebase
