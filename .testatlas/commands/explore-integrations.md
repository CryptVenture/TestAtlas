...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT probe production endpoints when allowProductionTesting=false. Does NOT trigger real charges, real emails, real SMS, or real OAuth grants. Does NOT fabricate integration metadata when web-fetch is unavailable — degrade per bootstrap §4.
---

# TestAtlas Command: explore-integrations
