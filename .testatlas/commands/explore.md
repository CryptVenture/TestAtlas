...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT produce findings, app-map entries, domain artifacts, or evidence. Does NOT invoke sub-explorers. Outputs a recommendation document only at _testatlas/explore-plan.md.
---
