...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT auto-heal in v1 (Phase 5 ships --auto-heal). Does NOT delete artifacts. Does NOT modify _testatlas/ except for lifecycle records and an optional report file. Surfaces validation findings only.
---
