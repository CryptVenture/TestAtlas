...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT execute the generated tests. Does NOT modify flow or issue source files. Only writes skeleton files under `_testatlas/tests/generated_automation/<framework>/`.
---

# TestAtlas Command (V2 test): generate-automation
