...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT delete V1 content. Does NOT move user-authored files outside the workspace. Creates new V2 directories and a backup tarball; existing V1 artifacts remain in place.
---
