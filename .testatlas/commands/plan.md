...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT execute tests (test-flow's job). Does NOT include scenarios for capabilities not yet declared by adapters. Strategy is reasoning-derived; per-scenario confidence applies via bootstrap §11 not §8.
---

# TestAtlas Command: plan
