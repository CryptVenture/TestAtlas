...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT modify the fix. Does NOT trigger product behavior. Read-only over the issue, the retest pack, and the new evidence; writes only to the session folder.
---

# TestAtlas Command (V2 council): council-retest
...
5. Inspect the target issue and its retest pack.
