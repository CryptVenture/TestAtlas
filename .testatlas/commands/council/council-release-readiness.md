---
command: council-release-readiness
version: 2.0.0
...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT trigger releases. Does NOT modify CHANGELOG.md, package.json, version files, or git tags. Read-only over the brain plus the session folder.
---

# TestAtlas Command (V2 council): council-release-readiness
...
5. Inspect `_testatlas/brain/state.json`, `_testatlas/brain/issues.json`, `_testatlas/brain/coverage.json`, `_testatlas/brain/drift.json`.
