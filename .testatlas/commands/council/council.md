...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT execute persona work itself. Does NOT modify canonical artifacts. Read-only over `_testatlas/` plus the routing decision log.
---

# TestAtlas Command (V2 council umbrella): council
