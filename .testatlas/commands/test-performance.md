...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT navigate to production hosts when allowProductionTesting=false. Does NOT trigger destructive flows during traces. Does NOT fabricate trace data, throttling profiles, or timing metrics when MCP/browser unavailable — degrade per bootstrap §4.
---

# TestAtlas Command: test-performance
