...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT modify any source artifact (read-mostly aggregator). Does NOT include findings without evidence-path cites. Does NOT include severity claims unsupported by issue records.
---

# TestAtlas Command: report
