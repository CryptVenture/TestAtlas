...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT execute destructive commands when allowDestructiveActions=false. Does NOT mutate target-repo source files. Does NOT fabricate command listings, help text, or exit codes when shell unavailable — degrade per bootstrap §4.
---

# TestAtlas Command: explore-cli
