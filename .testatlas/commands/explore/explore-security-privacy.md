---
command: explore-security-privacy
version: 2.0.0
...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT execute live exploits, brute-force credentials, or DDoS the target. Does NOT bypass production safeguards. Does NOT fabricate vulnerability findings when MCP/browser/shell unavailable — degrade per bootstrap §4.
---

# TestAtlas Command (V2): explore-security-privacy
