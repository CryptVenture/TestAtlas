...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT mutate test source. Does NOT skip or rewrite failing tests. Does NOT fabricate coverage numbers when shell unavailable — degrade per bootstrap §4.
---

# TestAtlas Command (V2): explore-tests
