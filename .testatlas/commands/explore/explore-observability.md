...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT publish synthetic alerts to production paging. Does NOT mutate observability config. Does NOT fabricate log lines or metric values when shell unavailable — degrade per bootstrap §4.
---

# TestAtlas Command (V2): explore-observability
...
4. Inspect `_testatlas/12_app_map.json` and `_testatlas/maps/integrations.json`.
