...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT mutate target-repo docs. Does NOT fabricate document content or interpret docs without citing the source path. Does NOT auto-resolve doc-vs-code conflicts — flags them for the operator.
---

# TestAtlas Command: explore-docs
