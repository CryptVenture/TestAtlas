...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT modify .testatlas/ (suite tree). Does NOT mutate target-repo source files. Does NOT overwrite an existing _testatlas/ workspace; on existing workspace, do a partial-fill of missing files only.
---

# TestAtlas Command: init
