...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT run destructive bootstrap (DROP DATABASE, rm -rf, force-pulls). Does NOT modify target-repo source. Does NOT persist live secret values. Does NOT fabricate ports, env vars, or container configs when shell unavailable — degrade per bootstrap §4.
---

# TestAtlas Command: explore-runtime
