...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT read or persist production data rows. Does NOT execute migrations. Does NOT fabricate schemas or entity relationships when shell is unavailable — degrade per bootstrap §4. NEVER persists row contents; only schemas, counts, and lifecycle state.
---

# TestAtlas Command: explore-data
