...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT mutate the app-map (read-only consumer). Does NOT invent domains lacking evidence in 12_app_map.json — degrade with confidence needs-validation per bootstrap §4 if the app-map is sparse.
---

# TestAtlas Command: map-domains
