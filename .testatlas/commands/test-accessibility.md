...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT navigate to production hosts when allowProductionTesting=false. Does NOT modify target-repo source. Does NOT fabricate lighthouse scores, ARIA findings, focus order, or contrast ratios when MCP/browser unavailable — degrade per bootstrap §4.
---

# TestAtlas Command: test-accessibility
