...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT execute any product behavior. Does NOT modify domain/flow/issue artifacts. Refresh-of-understanding only — re-reads bootstrap and produces a lifecycle-close + brain event.
---

# TestAtlas Command (V2 core): bootstrap-refresh
