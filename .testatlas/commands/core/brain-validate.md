...
lifecycle:
  ...
  - history/run_log.md
boundary: Read-only validation. Does NOT mutate brain files. Only writes lifecycle close + the post-operation brain event.
---

# TestAtlas Command (V2 core): brain-validate
