...
lifecycle:
  ...
  - history/run_log.md
boundary: Does NOT navigate to production hosts when allowProductionTesting=false. Does NOT modify target-repo source. Does NOT fabricate accessibility scores, ARIA roles, focus order, or contrast values when MCP/browser unavailable — degrade per bootstrap §4.
---

# TestAtlas Command: explore-accessibility
