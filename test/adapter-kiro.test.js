...
//
// Structural assertions on the 30 generated Kiro adapter skill files.
...
test('Test 1: 30 derived atlas-*.md skill files exist', async () => {
  ...
  assert.equal(derived.length, 30, `expected 30 derived skill files; got ${derived.length}`);
