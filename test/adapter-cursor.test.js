...
test('Test 1: 32 derived atlas-*.mdc rule files exist (one per source command)', async () => {
  ...
  assert.equal(derived.length, 32, `expected 32 derived .mdc files; got ${derived.length}`);
