      ...
      JSON.stringify(
        {
          ...
          id: 'EVIDENCE-001',
          createdAt: '2026-05-05T11:32:00Z',
          createdBy: 'agent',
          source: { kind: 'file', path: 'evidence/EVIDENCE-001/note.md' },
      ...
      JSON.stringify(
        {
          $schema: 'https://testatlas.dev/schemas/v1/evidence.schema.json',
          id: 'EVIDENCE-002',
          createdAt: '2026-05-05T11:35:00Z',
          createdBy: 'agent',
          source: { kind: 'file', path: 'evidence/EVIDENCE-002-with-slug/note.md' },
          claim: 'slug-suffixed sidecar',
          confidence: 'verified',
        },
        null,
        2,
